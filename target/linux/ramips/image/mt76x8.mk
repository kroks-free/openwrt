...
define Device/kndrt31r30
  DTS := mt7628an_kroks_kndrt31r30
  IMAGE_SIZE := 14m
  DEVICE_TITLE := Kroks Rt-Pot mX DS
  $(Device/Kroks-mpci)
endef
TARGET_DEVICES += kndrt31r30

define Device/kndrt31r31
  DTS := mt7628an_kroks_kndrt31r31
  IMAGE_SIZE := 14m
  DEVICE_TITLE := Kroks Rt-Ubx 2mX EC DS
  $(Device/Kroks-mpci)
endef
TARGET_DEVICES += kndrt31r31

define Device/kndrt31r33
  DTS := mt7628an_kroks_kndrt31r33
  IMAGE_SIZE := 14m
  DEVICE_TITLE := Kroks Rt-Pot2 mXw DS RSIM
  $(Device/Kroks-mpci)
endef
TARGET_DEVICES += kndrt31r33

define Device/kndrt31r34
  DTS := mt7628an_kroks_kndrt31r34
  IMAGE_SIZE := 14m
  DEVICE_TITLE := Kroks Rt-Pot2 mXw DS
  $(Device/Kroks-mpci)
endef
TARGET_DEVICES += kndrt31r34
