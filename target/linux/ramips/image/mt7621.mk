...
define Device/kroks_kndrt42r1
  ...
  $(Device/Kroks-usbstor)
  DEVICE_PACKAGES += kmod-mt7915-firmware
  SUPPORTED_DEVICES += kndrt42r1 kndrt41r5
endef
TARGET_DEVICES += kroks_kndrt42r1

define Device/kroks_kndrt42r2
  $(Device/dsa-migration)
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 30m
  DEVICE_VENDOR := Kroks
  ...
  $(Device/Kroks-mm)
  DEVICE_PACKAGES += kmod-mt7915-firmware
  SUPPORTED_DEVICES += kndrt42r2 kndrt41r9
endef
TARGET_DEVICES += kroks_kndrt42r2

define Device/kroks_kndrt42r3
  $(Device/dsa-migration)
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 30m
  DEVICE_VENDOR := Kroks
  ...
  $(Device/Kroks-usbstor)
  DEVICE_PACKAGES += kmod-mt7915-firmware
  SUPPORTED_DEVICES += kndrt42r3 kndrt41r13
endef
TARGET_DEVICES += kroks_kndrt42r3

define Device/kroks_kndrt42r4
  $(Device/dsa-migration)
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 30m
  DEVICE_VENDOR := Kroks
  ...
  $(Device/Kroks-mm)
  DEVICE_PACKAGES += kmod-mt7915-firmware
  SUPPORTED_DEVICES += kndrt42r4 kndrt41r12
endef
TARGET_DEVICES += kroks_kndrt42r4

define Device/kroks_kndrt42r5
  $(Device/dsa-migration)
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 30m
  DEVICE_VENDOR := Kroks
  ...
  $(Device/Kroks-mm)
  SUPPORTED_DEVICES += kndrt42r5 kndrt41r8
endef
TARGET_DEVICES += kroks_kndrt42r5

define Device/kroks_kndrt42r6
  $(Device/dsa-migration)
  $(Device/uimage-lzma-loader)
  IMAGE_SIZE := 30m
  DEVICE_VENDOR := Kroks
  DEVICE_MODEL := Rt-Pot W6 G
  DEVICE_PACKAGES := kmod-mt7915-firmware
  SUPPORTED_DEVICES += kndrt42r6 kndrt41r11
endef
TARGET_DEVICES += kroks_kndrt42r6
